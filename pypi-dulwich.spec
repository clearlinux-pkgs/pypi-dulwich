...
Source0  : https://files.pythonhosted.org/packages/8e/99/7f139ec0e9d224542115ef070c79503bcb271edaaf0c1e049a5fbdaad6a5/dulwich-0.20.45.tar.gz
Source1  : https://files.pythonhosted.org/packages/8e/99/7f139ec0e9d224542115ef070c79503bcb271edaaf0c1e049a5fbdaad6a5/dulwich-0.20.45.tar.gz.asc
...
BuildRequires : pypi(fastimport)
BuildRequires : pypi(geventhttpclient)
...
%prep
%setup -q -n dulwich-0.20.45
cd %{_builddir}/dulwich-0.20.45
pushd ..
cp -a dulwich-0.20.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661969675
